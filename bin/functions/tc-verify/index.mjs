...
/**
 *
 * This Lambda function serves as the entry point for the TrustCenter verification process.
 * It handles incoming events, logs information, validates the payload, verifies it, and returns a response.
...
export async function lambda_handler(event, context) {
    ...
    try {
        ...
        const post_request = async (payload) => {
            ...
            return await service.asymmetric_verify(payload.data)
        }
